...
<h6>Hack for LA</h6>
<p><a href="https://www.hackforla.org">Hack for LA</a> was in need of a consolidated data analytics strategy to track and manage data from several different user experience surveys to be administered to a range of internal and external stakeholders continuedly. In the first phase of this project, I created a series of UX surveys to measure customer satisfaction, gauge user sentiment, and solicit feedback for feature design. In the second phase, I created a set of desktop and mobile analytics dashboards using Google Data Studio, which ingested data from a variety of sources so that key metrics, KPIs, and user sentiment could be visualized and interpreted by leadership, marketed to stakeholders, and shared with internal teams. An accompanying set of <a href="https://www.figma.com/file/0RRPy1Ph7HafI3qOITg0Mr/Hack-for-LA-Website?node-id=986%3A1158">Survey Reporting Guidepage</a> wireframes were created in Figma to educate current and future team members on the data design process.</p>
<table>
<tbody>
<tr>
<td width="234">
